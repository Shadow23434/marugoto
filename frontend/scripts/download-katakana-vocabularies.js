#!/usr/bin/env node
/**
 * Download all vocabulary images referenced in katakana.json (vocabImgUrl fields).
 *
 * Source fields:
 *   - (data/<lang>/katakana.json).groups[*].characters[*].vocabularies[*].vocabImgUrl
 *
 * Default output:
 *   assets/images/katakana/vocabularies/<filename>
 *
 * Usage (PowerShell on Windows):
 *   node scripts/download-katakana-vocabularies.js
 *   node scripts/download-katakana-vocabularies.js --lang en
 *   node scripts/download-katakana-vocabularies.js --lang all
 *   node scripts/download-katakana-vocabularies.js --input data/en/katakana.json
 *   node scripts/download-katakana-vocabularies.js --outDir assets/images/katakana/vocabularies
 *   node scripts/download-katakana-vocabularies.js --concurrency 6 --retries 2 --force
 *   node scripts/download-katakana-vocabularies.js --limit 10
 *
 * Flags:
 *   --input <path>     Path to a specific katakana.json (overrides --lang)
 *   --lang <code>      One of en|ja|es|all (default: en)
 *   --outDir <path>    Destination directory (default: assets/images/katakana/vocabularies)
...
function parseArgs(argv) {
  const args = {
    lang: "en",
    outDir: path.join("assets", "images", "katakana", "vocabularies"),
    force: false,
    concurrency: 6,
    retries: 2,
    delay: 200,
...
function extractVocabImgUrls(katakanaJson) {
  const urls = new Set();
